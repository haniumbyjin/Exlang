...
//	@RequestMapping("/view")
//	String view(int articleCode,Model model) {
////		service.incRef(noticeCode);
//		
//		Article item=service.item(articleCode);
//		
//		System.out.println(item.getUpFilename()+"<<<<<<<<Filename");
//		int totalcomment=service.countComment(articleCode);
//		
...
//	
	...
	String add(Article item, HttpSession session, long mCode) {
	...
	String update(long articleCode,Model model) {
		Article item=service.item(articleCode);
	...
	String delete(long articleCode, long mCode) {
