...
import kr.ac.kopo.model.frecommend;
import kr.ac.kopo.model.nrecommend;
...
//		service.incRef(noticeCode);
		...
		List<Notice> list = service.list(mCode);
	...
	String add(Notice item, HttpSession session, long mCode) {
	...
	String delete(long noticeCode, long mCode) {
		service.delete(noticeCode);
		
		return "redirect:/notice/view/"+mCode;
	}
}
